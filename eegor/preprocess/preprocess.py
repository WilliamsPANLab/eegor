...
def reject(epochs, config, verbose="tqdm"):
    ...
    """
    seed = config["seed"]
    picks = mne.pick_types(epochs.info, meg=False, eeg=True, stim=False, eog=True, ecg=False)
    ...
    ar = AutoReject(thresh_method="bayesian_optimization", random_state=seed, verbose=verbose)
